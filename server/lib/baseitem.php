...
abstract class BaseItem
{
	...
	// here false means "unknown", null means "no parent".
	private $parent_node = false;

	/*
	 * id (primary key) of this item, a value to the table's key.
	 */
	protected $id = null;
	...
	function __construct( $item_id = null, $preload = '' )
	{
		...
		{
			if( $preload != '' ) {
				error( "BaseItem: trying to preload data ($preload) from undefined item_id" );
			}
			return;
		}
	...
	function __toString()
	{
		return "db item $this->table_name#$this->id";
	}
}
?>